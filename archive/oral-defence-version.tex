...
% main opponent of this dissertation.
...
case-by-case basis is indispensable. This \qnull{full employment
  theorem} of probability kinematicsis is widely promulgated by
...
A similar sentiment is expressed in \scite{8}{grovehalpern97}{210}.
...
\begin{quotex}
  ...
  only \qnull{right} way to update, especially in an incompletely
...
This is echoed both in Halpern's textbook \emph{Reasoning About
  Uncertainty}, where Halpern emphasizes that \qeins{there is no
  escaping the need to understand the details of the application}
(\scite{10}{halpern03}{423}), and by Richard Bradley, who determines
that much \qeins{will depend on the judgmental skills of the agent,
  typically acquired not in the inductive logic class but by subject
  specific training} \scite{2}{bradley05}{349}.
...
employment theorem that \qeins{one must always think carefully about
  precisely what the information means} \scite{2}{grovehalpern97}{6},
and \qeins{the only right way to update, especially in an incompletely
  specified situation, is to think very carefully about the real
...
with Bradley that \qeins{even Bayes' rule \qzwei{should not be thought
    of as a universal and mechanical rule of updating, but as a
    technique to be applied in the right circumstances, as a tool in
    what Jeffrey terms \emph{the art of judgment}.} In the same way,
  determining and adapting the weights [epistemic entrenchment]
  supposes, or deciding when Adams conditioning applies, may be an
  art, or a skill, rather than a matter of calculation or derivation
  from more fundamental epistemic principles}
\scite{2}{douvenromeijn09}{16} (for the Bradley quote see
\scite{8}{bradley05}{362}).
...
patient. \qeins{The collection of all the logically unrelated
  medicines and treatments,} Jaynes explains, \qeins{that a sick
  patient might need [is] too large for anyone but a dedicated
  professional to learn} \scite{3}{jaynesbretthorst03}{492}. To
...
\begin{quotex}
  ...
  \scite{3}{jaynesbretthorst03}{506}
\end{quotex}

Diaconis and Zabell warn \qeins{that any claims to the effect that
...
evidence compels you to gain it (see \scite{8}{jaynes88}{280}; van
Fraassen \scite{10}{fraassenetal86}{376}; \scite{8}{zellner88}{278};
and \scite{8}{klir06}{356}). The principle comes with its own formal
...
(see van Fraassen et al., \scite{11}{fraassenetal86}{}), but do not
...
another where \qnull{beliefs} are reflections of a more deeply rooted,
...
and Bruno de Finetti (see de Finetti, \scite{11}{definetti31}{} and
\scite{11}{definetti37}{}). They personify a divide in the camp of
...
to the use to which it is put (see \scite{7}{carnap52}{}).
...
each other (see von Mises, \scite{10}{mises64}{161}). According to van
Fraassen, {\xample} \ref{ex:waterwine} shows why we should
\qeins{regard it as clearly settled now that probability is not
  uniquely assignable on the basis of a principle of indifference}
(van Fraassen, \scite{10}{fraassen89}{292}). Van Fraassen goes on to
...
\scite{8}{mikkelson04}{137}; and \scite{7}{gyenisredei15}{}). Donald
Gillies calls von Mises' paradox a \qeins{severe, perhaps in itself
  fatal, blow} to Keynes' logical theory of probability (see
...
\scite{2}{savage54}{67}. My defence of \textsc{pme} is not
inconsistent with this principle.

% Consider an analogy to Carnap's conventionalism in geometry (about
% which I have written in \scite{7}{lukits14a}{}). A subjectivist
% interpretation of probability sidelines the frequentist's question
...
% geometry corresponds to the real world. In analogy to conventionalism,
% the logical interpretation attends to what is reasonable to believe
% given certain formal rules that we accept even if we have no
% Archimedean leverage point to start.
...
% substance. This dissertation is an attempt to showcase these features
% in the details of the formal account and the treatment of particular
% cases, especially when the logical interpretation is paired with
% information theory.
...
events under consideration. It is the disclaimer \qnull{under
  consideration} that will give me the leverage for synchronic
constraints. 
...
\begin{quotex}
  \beispiel{Trump Standard Conditioning}\label{ex:equuhuex} A
...
\begin{quotex}
  \beispiel{Trump Jeffrey Conditioning}\label{ex:poonahva}
...
\begin{quotex}
  \beispiel{Trump Affine Constraint}\label{ex:eikaetai} Due
...
\begin{quotex}
  \beispiel{Trump Marginal Probabilities}\label{ex:axothuir}
  ...
  \qnull{Cruz will win the Republican nomination and Clinton will win
    the Democratic nomination}. Given the marginal probabilities, many
...
\textsc{pme} (see \scite{7}{jaynes57a}{}; \scite{11}{jaynes57b}{}), he
is less indebted to the philosophy of science project of giving an
account of semantic information (as in \scite{7}{carnapbarhillel52}{};
\scite{11}{carnapbarhillel53}{}) than to Claude Shannon's mathematical
...
\scite{7}{levi67}{}) debates on partial belief and acceptance
...
\scite{7}{jeffrey70}{}), set the stage for two \qnull{epistemological
  dimensions} (Henry Kyburg's term, see \scite{8}{kyburg95}{343}),
...
updating rule (Bayes' theorem) is the \qeins{optimal information
  processing rule} \scite{2}{zellner88}{278}, also using Lagrange
...
(see \scite{7}{friedmanshimony71}{}; \scite{7}{diasshimony81}{};
\scite{7}{shimony93}{}) note the following problem. 

\begin{quotex}
  \beispiel{Shimony's Lagrange Multiplier}\label{ex:phooxaik} You
...
objectivism are not tenable (see \scite{7}{skyrms85}{};
\scite{11}{skyrms86}{}; and \scite{11}{skyrms87}{}). In
...
criticism (see \scite{8}{jaynes85}{134ff}). While $z$ is a legitimate
...
\scite{11}{fraassen81}{}) deals another blow to \textsc{pme} in the
...
textbook on uncertainty (see \scite{7}{halpern03}{}). I will cover the
...
articles such as \qeins{Why I Am Not an Objective Bayesian} (see
\scite{7}{seidenfeld79}{}; \scite{11}{seidenfeld86}{}). Jos Uffink
takes issue with Shore and Johnson, casting doubt on the uniqueness
claims of \textsc{pme} (see \scite{7}{uffink95}{};
\scite{11}{uffink96}{}). Carl Wagner introduces a counterexample to
...
Gr{\"u}nwald and the concept of \qnull{coarsening at random,} which
according to the authors demonstrates that the \textsc{pme}
\qeins{essentially never gives the right results} (see
\scite{8}{gruenwaldhalpern03}{243}). A CAR condition specifies the
...
In 2009, Douven and Romeijn write an article on the \emph{Judy
  Benjamin} problem (see \scite{7}{douvenromeijn09}{}) in which they
...
in Carl Hempel (see \scite{8}{hempel45}{107}) and is raised again as
late as 2005 by James Joyce (see \scite{8}{joyce05}{170f}). Peter
...
Wednesdays, and Fridays (see \scite{8}{earman92}{1}; for the detailed
criticism \scite{8}{earman92}{139f}).

Gillies also has these reservations (see \scite{8}{gillies00}{81; 84})
...
\scite{8}{zabell05}{25}, where he repeatedly charges that advocates of
logical probability have never successfully addressed Ramsey's
\qeins{simple criticism} about how to apply observations to the
...
\scite{7}{khinchin57}{}). While interesting, making one of information
...
spirited rebuttal (see \scite{8}{jaynes85}{134ff}). 
% This brings us, obviously, to the matter of
...
out five times (see \scite{7}{hobson72}{};
\scite{7}{tribusmotroni72}{}; \scite{7}{gagehestenes73}{};
\scite{7}{jaynes78}{}; \scite{7}{cyranski79}{}). This does not,
...
\scite{7}{spohn12}{}, provides an account of what it means for an
...
\scite{7}{landeswilliamson13}{}; for more detail on affine constraints
see \scite{7}{csiszar67}{}; \scite{8}{williams80}{137};
...
following properties (see \scite{7}{khinchin57}{}, for these axioms; I
gleaned them from \scite{8}{guiasu77}{9}):
...
% A rational agent accepts the probability
...
objection see \scite{8}{walley91}{270f}). Here is a brief excursion to
dispel this worry.
...
\scite{8}{jaynes89}{243}, and {\xample}~\ref{ex:brandeis}). Jaynes'
...
in Theorem 12.1.1 in Cover and Thomas \scite{1}{coverthomas06}{} and
...
\texttt{http://www-mtl.mit.edu/Courses/6.050/2013/notes},
subsection~9.6.3. Exercise 12.2. (see \scite{8}{coverthomas06}{409})
...
\scite{7}{landeswilliamson13}{}.) Information theory and its virtues
...
%   acceptance of such foolishness, but it does tolerate it.
%   \scite{3}{salmon67}{81}
% \end{quotex}
...
of information theory's principles saddles us with \qeins{absurdities
  that qualify as rational} (quoting from \scite{8}{salmon67}{81}, in
...
% conditioning do not always apply. 
...
that motivates Jeffrey conditioning (see \scite{7}{wagner92}{}). I
...
a \qeins{natural generalization of Jeffrey conditioning} (see
\scite{8}{wagner92}{250}), but also to deepen criticism of
\textsc{pme}.
...
\scite{7}{walley91}{}; and \scite{7}{joyce10i}{}). The following table
...
\scite{7}{white10}{}; and \scite{7}{elga10}{}). (I) is the negation of
...
subjective probabilities see \scite{8}{hajek03}{313}). Newton did not
...
\scite{8}{debbahmueller05}{1674}). 

% This avoids the introduction of unjustified information corresponding
% to the simple intuition behind \textsc{pme}: when updating your
% probabilities, waste no useful information and do not gain information
% unless the evidence compels you to gain it (see
% \scite{8}{fraassenetal86}{376}; \scite{7}{zellner88}{};
% \scite{7}{jaynes88}{}; and \scite{8}{palmiericiuonzo13}{186}).

% The principle comes with its own formal apparatus, not unlike
% probability theory itself: Shannon's information entropy (see
% \scite{7}{shannon48}{}), the Kullback-Leibler divergence (see
% \scite{7}{kullbackleibler51}{}; \scite{7}{kullback59}{};
% \scite{8}{guiasu77}{308ff}; and \scite{8}{seidenfeld86}{262ff}), the
% use of Lagrange multipliers (see \scite{8}{coverthomas06}{409ff};
% \scite{8}{guiasu77}{327f}; and \scite{8}{seidenfeld86}{281}), and the
% log-inverse relationship between information and probability (see
% \scite{7}{kampe67}{}; \scite{7}{ingardenurbanik62}{};
% \scite{7}{khinchin57}{}; and \scite{7}{kolmogorov68}{}).
...
Joyce in \scite{11}{joyce10i}{} and other papers). Proponents of
...
discussed here (see, for example, \scite{7}{boole54}{},
chapters~16--21).\fcut{1}
...
problematic.\fcut{2}\bcut{2}\mcut{1} The primary task of Bayesians is
...
argument \qeins{goes awry by assuming that credal states which assign
  the same range of credences for an event reflect the same opinions
  about that event} \scite{2}{joyce10i}{304}, when in the following he
...
events (see \scite{8}{jeffrey65}{153ff}), expressible in a shift in
expectation (see \scite{7}{hobson71}{}). Jeffrey conditionalization
...
Diaconis and Zabell state: \qeins{any claims to the effect that
  maximum-entropy revision is the only correct route to probability
  revision should be viewed with considerable caution}
...
\qeins{Conditioning using Conditional Expectations: The
  Borel-Kolmogorov Paradox} by Zal{\'a}n Gyenis, Mikl{\'o}s R{\'e}dei,
...
\scite{7}{walley91}{}, Appendix I). I replicated the experiment using
...
% We are not on a train, where a set of rail-road tracks carries us
% securely towards foregone conclusions.
...
% I end with Laplace's last words, according to Joseph Fourier's account
% pronounced with difficulty: ``Ce que nous connaissons est peu de
% chose, ce que nous ignorons est immense'' (Joseph Fourier, {\'E}loge
% historique de M.~le Marquis de Laplace, delivered 15 June 1829).
