...
\scite{7}{walley91}{}, Appendix F).\tbd{check reference} I replicated
...
theory (see \scite{8}{walley91}{34}; and \scite{8}{joyce10}{311} for
...
\begin{quotex}
  ...
  $B$ from urn $A$ with two balls. We draw from urn $B$.
\end{quotex}
...
\begin{quotex}
  \textbf{Example \arabic{expls}: \addtocounter{expls}{1} Three
    Prisoners.} The Three Prisoners problem is well-known and
  well-documented (see \scite{8}{mosteller87}{28}). Let the three
  prisoners be $X_{1},X_{2},X_{3}$ and the warden tell $X_{1}$ that
  $X_{3}$ will be executed.
\end{quotex}
