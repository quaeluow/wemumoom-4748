...
to hold sharp credences as \qnull{Booleans} (e.g.\ Peter Walley and
...
\scite{8}{augustin03}{35f}); Alan H{\'a}jek and Michael Smithson's
belief that there may be objectively indeterminate chances in the
physical world (see \scite{8}{hajeksmithson12}{33}); and Jake
Chandler's claim that \qeins{the sharp model is at odds with a trio of
plausible propositions regarding agnosticism}
\scite{2}{chandler14}{4}.  This paper addresses (A) and (B), while
...
\scite{7}{walley91}{}, Appendix F).\tbd{check reference}
...
(see \scite{7}{white10}{} for examples). White's objection, even
...
see \scite{8}{joyce10}{289}). Dilation from a sharp $0.5$ to an
...
\begin{quotex} \textbf{Example \arabic{expls}: \addtocounter{expls}{1}
    Dilating Urns.} You draw from an urn with 200 balls (100 red, 100
...
sharp credences \qeins{ignore a vast number of possibilities that are
...
\scite{7}{spohn12}{}, especially chapter 10). White's objection fails,
...
\scite{8}{white10}{171}). What is really at play is a complex
...
\scite{8}{walley91}{632}) to settle the bets. The simulation results
