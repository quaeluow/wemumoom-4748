...
$H_{\mbox{\tiny{iv}}}\equiv{}H_{\mbox{\tiny{v}}}$ is inadmissible
information, and the argument for (B) fails.\bcut{15} On this point, I
...
\begin{quotex}
  \beispiel{Aggregating Expert Opinion}\label{ex:aggreg} You have no
...
\begin{quotex}
  \beispiel{Precise Credences}\label{ex:preccre} Your sharp credence
