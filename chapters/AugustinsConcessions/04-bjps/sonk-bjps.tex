...
position (see \scite{7}{kaplan10}{}; \scite{7}{hajeksmithson12}{};
\scite{7}{moss13}{}; \scite{7}{chandler14}{}; and
\scite{7}{weisberg15}{}). Here is an illustration in H{\'a}jek and
Smithson.
...
correctly identifies, see \scite{8}{joyce10}{305}) to construct an
...
Joyce, with specific reference to instates: \qeins{The imprecise
  ...
  produce optimal decisions} \scite{2}{augustin03}{41} (see also an
example for inadequate representation of evidence by instates in
\scite{8}{bradleysteele13}{16}). 
...
contains a calculation error (see \scite{8}{joyce10}{294};
...
\qeins{are based on an overly narrow conception of imprecise belief
  states which assumes that we know everything there is to know about
  a person's doxastic attitudes once we have identified the spreads of
