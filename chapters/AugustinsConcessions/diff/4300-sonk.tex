...
\scite{7}{walley91}{}, Appendix F).\tbd{check
  reference} I replicated the experiment using two
...
on little information (see \scite{7}{white10}{} for
...
CGT, see \scite{8}{joyce10}{289}). Dilation from a
...
\scite{8}{walley91}{34}; and \scite{8}{joyce10}{311}
...
balls are drawn (see \scite{8}{white10}{171}). What is
...
Lewis' 1981 paper \qeins{A Subjectivist's Guide to
  Objective Chance} addresses the question what the
...
\begin{quotex}
  \textbf{Example \arabic{expls}:
    \addtocounter{expls}{1} Monkey-Filled Urns.} E.T.
...
\begin{quotex}
  ...
  Prisoners problem is well-known and well-documented
  (see \scite{8}{mosteller87}{28}). Let the three
  prisoners be $X_{1},X_{2},X_{3}$ and the warden tell
  $X_{1}$ that $X_{3}$ will be executed.
\end{quotex}
...
example \scite{8}{joyce10}{311ff}; for an opponent's
view of this see \scite{8}{elga10}{6ff}). The problem
