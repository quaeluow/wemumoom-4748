...
in an unpublished paper by Aaron Bronfman, \qeins{A Gap in Joyce's
  Argument for Probabilism} (Joyce's response is in
\scite{8}{joyce09}{288f}). 
...
\scite{7}{stephens01}{}). A set of full beliefs, however, can be
