...
path c1=circle(A,.1*scl*m);
path c1v=circle(A,.15*scl*m);
path c2=circle(A,.2*scl*m);
path c2v=circle(A,.25*scl*m);
path c3=circle(A,.3*scl*m);
path c3v=circle(A,.35*scl*m);
path c4=circle(A,.4*scl*m);
path c4v=circle(A,.45*scl*m);
path c5=circle(A,.5*scl*m);
path c5v=circle(A,.55*scl*m);
path c6=circle(A,.6*scl*m);
path c6v=circle(A,.65*scl*m);
path c7=circle(A,.7*scl*m);
path c7v=circle(A,.75*scl*m);
path c8=circle(A,.8*scl*m);
path c8v=circle(A,.85*scl*m);
path c9=circle(A,.9*scl*m);
path c9v=circle(A,.95*scl*m);
path c10=circle(A,1*scl*m);
path c10v=circle(A,1.05*scl*m);
path c11=circle(A,1.1*scl*m);

pen norlin=linewidth(1);

picture conc;
draw(conc,c1,norlin);
draw(conc,c1v,norlin);
draw(conc,c2,norlin);
draw(conc,c2v,norlin);
draw(conc,c3,norlin);
draw(conc,c3v,norlin);
draw(conc,c4,norlin);
draw(conc,c4v,norlin);
draw(conc,c5,norlin);
draw(conc,c5v,norlin);
draw(conc,c6,norlin);
draw(conc,c6v,norlin);
draw(conc,c7,norlin);
draw(conc,c7v,norlin);
draw(conc,c8,norlin);
draw(conc,c8v,norlin);
draw(conc,c9,norlin);
draw(conc,c9v,norlin);
draw(conc,c10,norlin);
draw(conc,c10v,norlin);
draw(conc,c11,norlin);
clip(conc,elt,norlin);
add(conc);
