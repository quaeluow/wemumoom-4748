...
// data is from s1772.m
pair P=x0000+(0.66291*scl*m,0.35722*scl*m);
pair PL=x0000+(0.48614*scl*m,0.15309*scl*m);
pair Q=x0000+(0.61872*scl*m,0.30619*scl*m);
pair QL=x0000+(0.44194*scl*m,0.10206*scl*m);
pair XI=x0000+(.35*scl*m,0*scl*m);
path mx=(X--M);
path my=(Y--M);
path mz=(Z--M);
path mxx=(X--Xx);
