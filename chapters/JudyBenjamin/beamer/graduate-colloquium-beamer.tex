...
\begin{figure}[h]
\includegraphics[scale=1.1]{../diagrams/constraint-a.pdf}
\end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{The Principle of Maximum Entropy}
\begin{figure}[h]
\includegraphics[scale=1.1]{../diagrams/constraint-b.pdf}
\end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{The Principle of Maximum Entropy}
\begin{figure}[h]
\includegraphics[scale=1.1]{../diagrams/constraint-c.pdf}
\end{figure}
\end{frame}
