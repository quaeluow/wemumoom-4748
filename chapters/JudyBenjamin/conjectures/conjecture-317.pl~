...
$tmax=8;
$smax=8;
open(output1,">./conjecture-317-1.htm");
open(output2,">./conjecture-317-2.htm");
open(output3,">./conjecture-317-3.htm");
print output1 "<html><head><title>Conjecture 317</title></head><body><table border=5><tr><td><tt></tt></td>";
print output2 "<html><head><title>Conjecture 317</title></head><body><table border=5><tr><td><tt></tt></td>";
print output3 "<html><head><title>Conjecture 317</title></head><body><table border=5><tr><td><tt></tt></td>";
