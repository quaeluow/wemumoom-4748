...
In his paper \qeins{Marginal Probability Distribution Determined by
  the Maximum Entropy Method} (see [13]), Vladim{\'\i}r Majern{\'\i}k
...
approach. Wagner legitimately calls his solution a \qeins{natural
  generalization of Jeffrey conditioning} (see [20, 250]). There is,
...
[6] Guia{\c{s}}u, Silviu. \emph{Information Theory with Application}. New York, NY: McGraw-Hill, 1977. 
