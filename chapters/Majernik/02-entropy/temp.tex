...
\begin{equation}
\label{eq:zeta}
\zeta=(0,\ldots,0,1)^{\intercal}\mbox{ with }\zeta_{m}=1\mbox{ and }\zeta_{i}=0\mbox{ for }i\neq{}m.
\end{equation}
...
\section{Appendix: The Principle of Maximum Entropy generalizes Jeffrey Conditioning}
\label{appendix}
