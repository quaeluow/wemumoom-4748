% This is no longer the official file. The official files are
% ./Majernik/02-entropy/majernik-overleaf.tex and
% ./Majernik/02-entropy/majernik-overleaf.pdf

%I prepared this file for Landes submission at
%http://www.mdpi.com/journal/entropy/special_issues/max_log_res on
%2014-10-29.

%So, I have a problem here. If we can assign probabilities
%retrospectively, then the Wagner scenario is trivially resolved in
%terms of Jeffrey Conditioning. Consider events w1,\dots,w5 and
%t1,\dots,t4. Then Q(ti)=sum_j=1to4 P(ti|wj)Q(wj) -- fortunately, this
%doesn't work since P(ti|wj) is just what is in question. t1=northern
%Catholic, for example, and w1=Catholic piety. We know what P(C|w1) is,
%but what is P(N&C|w1)?

%However, do keep in mind to tailor the paper to fit the theme (adding a section or two on inductive logic); this might take some time.
...
%the following title for Landes special edition
...
Here is some bibliography help: \scite{7}{kampe67}{},
\scite{7}{ingardenurbanik62}{}, \scite{7}{kolmogorov68}{},
\scite{7}{khinchin57}{}, \scite{7}{veveakisregenauer15}{},
\scite{7}{palmiericiuonzo13}{}, \scite{7}{debbahmueller05}{},
\scite{7}{jaynes88}{}, \scite{7}{fraassenetal86}{},
\scite{7}{zellner88}{}.
